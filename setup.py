...
executables=[cx_Freeze.Executable("sentiment.py",base=base,icon='favicon.ico')]

cx_Freeze.setup(
    name="rjecnik",
    options={"build_exe":{"packages":["tkinter","nltk","io",'atexit', 'numpy.core._methods', 'numpy.lib.format',"textblob","sys"],
